...
if(price_sale.trim()!=''){$(".price-sale").empty().text(price_sale)
$(".price-regular").empty().text(price_regular)}else{$(".price-regular").empty();$(".price-sale").empty().text(price_regular)}
