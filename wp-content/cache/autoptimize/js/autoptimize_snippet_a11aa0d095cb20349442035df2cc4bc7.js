...
alert(Number.isInteger(price_sale))
if(price_sale!=''||Number.isInteger(price_sale)>0){$(".price-sale").empty().text(price_sale)
$(".price-regular").empty().text(price_regular)}else{$(".price-regular").empty();$(".price-sale").empty().text(price_sale)}
