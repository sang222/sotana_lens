...
$args = array(
    ...
    'menu_title' => __('Glass Custom', 'shop-glass'),
    'page_title' => __('Glass Custom', 'shop-glass'),
...
$args['admin_bar_links'][] = array(
    ...
    'title' => __('Documentation', 'shop-glass'),
);

$args['admin_bar_links'][] = array(
    //'id'    => 'redux-support',
    'href' => 'https://github.com/ReduxFramework/redux-framework/issues',
    'title' => __('Support', 'shop-glass'),
);

$args['admin_bar_links'][] = array(
    'id' => 'redux-extensions',
    'href' => 'reduxframework.com/extensions',
    'title' => __('Extensions', 'shop-glass'),
);
...
if (!isset($args['global_variable']) || $args['global_variable'] !== false) {
    ...
    $args['intro_text'] = sprintf(__('<p>Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: <strong>$%1$s</strong></p>', 'shop-glass'), $v);
} else {
    $args['intro_text'] = __('<p>This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.</p>', 'shop-glass');
}

// Add content after the form.
$args['footer_text'] = __('<p>This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.</p>', 'shop-glass');
...
$tabs = array(
    array(
        'id' => 'redux-help-tab-1',
        'title' => __('Theme Information 1', 'shop-glass'),
        'content' => __('<p>This is the tab content, HTML is allowed.</p>', 'shop-glass')
    ),
    array(
        'id' => 'redux-help-tab-2',
        'title' => __('Theme Information 2', 'mzway'),
        'content' => __('<p>This is the tab content, HTML is allowed.</p>', 'shop-glass')
    )
);
...
$content = __('<p>This is the sidebar content, HTML is allowed.</p>', 'shop-glass');
...
//            'subtitle' => __('Input banner title', 'shop-glass'),
        ...
        array(
            ...
            'multi' => true,
            'sortable' => true,
            'title' => __('Select category hot sale', 'shop-glass'),
...
if (!function_exists('dynamic_section')) {
    function dynamic_section($sections)
    {
        //$sections = array();
        $sections[] = array(
            'title' => __('Section via hook', 'mzway'),
            'desc' => __('<p class="description">This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.</p>', 'mzway'),
